---
title: "Evie Experience Sampling Method Project Walk Through"
output:
  html_document:
    toc: yes
  pdf_document:
...
The image below is a flowchar using LucidChart to illustrate the sequence and types of questions asked.
![](...) 
