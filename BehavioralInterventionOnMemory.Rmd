---
title: "Self-talk Intervention on Memory Performance in Children and Adults"
...
#07272020 checked
corpus_Win20_raw_after020720 <- read_csv("...")
Corpus_spring20_raw <- read_csv("...")
```
#Both
...
#07272020 checked
PreSurvey_Winter20_raw = read_csv("...")

PreSurvey_Spring20_raw = read_csv("...")
...
PID_Match_Wi20 = read_csv("...")[-c(1:3),c("Survey", "Question 5")]
PID_Match_Sp20 = read_csv("...")[-c(1:3),c("Survey", "Question 5")]
...
PrivateSpeech_Adult_1106<- read_csv("...")
...
PS_SONA_021120_performance <- read_csv("...")
...
library(dplyr)
ECEC_coding <- as.data.frame( read_csv("...")[, 1:10]) %>% filter(!is.na(Name))
...
PS_4Conditions_SONA_Win20<- read_csv("...")
...
clustered_EasinessLabel = read_csv("...")
